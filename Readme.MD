...
Note: During testing, we found that the SVM model did not perform well (around 40% accuracy). In future testing, we may exclude the SVM from our ensemble model to increase the accuracy.
